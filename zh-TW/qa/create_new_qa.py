...
<head>
    ...
    <meta name="description" content="拉玛那马哈希精选问答，探讨{topic}等核心主题。包含原汁原味的灵性对话与修行指引，助您深入理解马哈希的静默教示与自我参究法门，开启内在觉醒的修行之路。">
    <meta name="keywords" content="马哈希, 问答, 修行, 灵性, 真我, 自我">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://ramanamaharshi.space/qa/qa-{number}">
    <!-- Open Graph -->
    <meta property="og:title" content="{topic}问答 | 拉玛那马哈希150精选指南详解完整修行指南详解 | 拉玛那马哈希知识库">
    <meta property="og:description" content="拉玛那马哈希精选问答，探讨{topic}等核心主题。包含原汁原味的灵性对话与修行指引，助您深入理解马哈希的静默教示与自我参究法门，开启内在觉醒的修行之路。">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://ramanamaharshi.space/qa/qa-{number}">
    ...
    <title>{topic}问答 | 拉玛那马哈希150精选指南详解完整修行指南详解 | 拉玛那马哈希知识库</title>
...
'''
    ...
    for i in range(30):
        ...
        html_content = base_content.format(
            topic=topic,
            number=number,
            prev_link=prev_link,
            next_link=next_link
